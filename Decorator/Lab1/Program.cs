    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Part 2
            {
                ...
                {
                    parcels[i] = PM.ChangeParcelCubature(parcels[i], parcels[i].Weight * 2);
                    parcels[i] = PM.ChangeParcelWeight(parcels[i], parcels[i].Weight + 5);
                    parcels[i] = PM.MakeParcelExpress(parcels[i], 10);
                }
            }
            ...
            //Part 3
            {
                ...
                IParcel unreadableParcel = PM.MakeDescriptionUnreadable(parcels[5]);
                IParcel translatedDescriptionParcel = PM.TranslateDescription(parcels[5]);
